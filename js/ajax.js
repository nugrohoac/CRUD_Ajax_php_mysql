$( document ).ready(function() {
    ...
    function manageRow(data) {
        ...
        $.each( data, function( key, value ) {
            ...
            rows = rows + '<button data-toggle="modal" data-target="#delete-user" class="btn btn-danger btn-sm remove-user"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Hapus</button>';
            rows = rows + '</td>';
            rows = rows + '</tr>';
        });
        $("#tbody").html(rows);
